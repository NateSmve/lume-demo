            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              ...
              <div>
                ...
                <div className="flex flex-col gap-2 text-sm text-stone-400">
                  <a href="/#collection" className="underline decoration-stone-600 hover:text-amber-200 hover:decoration-amber-400 transition-colors">Shop</a>
                  <a href="/#story" className="underline decoration-stone-600 hover:text-amber-200 hover:decoration-amber-400 transition-colors">Our Story</a>
                  <a href="/contact" className="underline decoration-stone-600 hover:text-amber-200 hover:decoration-amber-400 transition-colors">Contact</a>
                </div>
              </div>
              <div>
                <p className="text-sm font-semibold text-stone-300 mb-3">
